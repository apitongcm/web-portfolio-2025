...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      >
        Projects & <span className="text-rose-600">Experiments</span>
      </motion.h1>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {repos.map((repo, i) => (
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            whileHover={{ scale: 1.02, borderColor: "#e11d48" }}
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {repo.languages.map((lang, i) => (
                <span
                  key={i}
                  className="text-[11px] tracking-wide uppercase border border-rose-600 text-rose-400 px-2 py-[2px] rounded-sm bg-[#1a1a1a]"
                >
                  {lang}
                </span>
              ))}
            ...
            <div className="flex justify-between items-center">
              <a
                ...
                className="text-gray-300 text-sm hover:text-rose-500 transition-colors"
              >
                View Repository →
              </a>
            </div>
            ...
            <motion.div
              className="absolute top-4 right-4 w-2 h-2 bg-rose-600 rounded-full shadow-[0_0_8px_rgba(225,29,72,0.6)]"
