  ...
  return (
   <>
    ...
    <div className='mb-6 px-4 sm:px-8 md:px-16 text-center sm:text-left'>
        <h2 className="text-3xl sm:text-3xl md:text-4xl mt-8 sm:mt-12 font-bold text-gray-800 mb-4 leading-tight max-[1021px]:text-gray-300">Carl Marwin <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500'>Apitong</span>, ECT, CC</h2>
